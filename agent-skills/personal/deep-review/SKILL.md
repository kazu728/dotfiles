---
name: deep-review
description: 差分を subagent 並列で多観点レビューし、検証を通った指摘だけ返す。/code-review high・/security-review・/harsh-review を subagent で並列実行し、集約した指摘を検証パスで再現・裏取りして false positive を落とす。「深くレビューして」「マージ前に徹底的に見て」「ultra 相当をローカルで」と頼まれたときに使う。
---
...
general-purpose subagent を3体並列で起動し、それぞれに1つの skill を実行させる。
